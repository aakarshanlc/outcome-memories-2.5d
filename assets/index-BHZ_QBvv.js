...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:0,depthTest:!1,depthWrite:!1})}function nc(e,t,n){let r=new Float32Array(Hs),i=new W(0,1,0);return new to({name:`SphericalGaussianBlur`,defines:{n:Hs,CUBEUV_TEXEL_WIDTH:1/t,CUBEUV_TEXEL_HEIGHT:1/n,CUBEUV_MAX_MIP:`${e}.0`},uniforms:{envMap:{value:null},samples:{value:1},weights:{value:r},latitudinal:{value:!1},dTheta:{value:0},mipInt:{value:0},poleAxis:{value:i}},vertexShader:ac(),fragmentShader:`
	...
	`}var oc=class extends qt{constructor(e=1,t={}){super(e,e,t),this.isWebGLCubeRenderTarget=!0;let n={width:e,height:e,depth:1},r=[n,n,n,n,n,n];this.texture=new $i(r),this._setTextureOptions(t),this.texture.isRenderTargetTexture=!0}fromEquirectangularTexture(e,t){this.texture.type=t.type,this.texture.colorSpace=t.colorSpace,this.texture.generateMipmaps=t.generateMipmaps,this.texture.minFilter=t.minFilter,this.texture.magFilter=t.magFilter;let n={uniforms:{tEquirect:{value:null}},vertexShader:`
...
`),r=[];for(let e=0,i=n.length;e<i;e++){let i=n[e].trimStart();if(i.length===0)continue;let a=i.charAt(0);if(a!==`#`){if(a===`v`){let e=i.split(Sf);switch(e[0]){case`v`:t.vertices.push(parseFloat(e[1]),parseFloat(e[2]),parseFloat(e[3])),e.length>=7?(Of.setRGB(parseFloat(e[4]),parseFloat(e[5]),parseFloat(e[6]),Be),t.colors.push(Of.r,Of.g,Of.b)):t.colors.push(void 0,void 0,void 0);break;case`vn`:t.normals.push(parseFloat(e[1]),parseFloat(e[2]),parseFloat(e[3]));break;case`vt`:t.uvs.push(parseFloat(e[1]),parseFloat(e[2]))}}else if(a===`f`){let e=i.slice(1).trim().split(Sf),n=[];for(let t=0,r=e.length;t<r;t++){let r=e[t];if(r.length>0){let e=r.split(`/`);n.push(e)}}let r=n[0];for(let e=1,i=n.length-1;e<i;e++){let i=n[e],a=n[e+1];t.addFace(r[0],i[0],a[0],r[1],i[1],a[1],r[2],i[2],a[2])}}else if(a===`l`){let e=i.substring(1).trim().split(` `),n=[],r=[];if(i.indexOf(`/`)===-1)n=e;else for(let t=0,i=e.length;t<i;t++){let i=e[t].split(`/`);i[0]!==``&&n.push(i[0]),i[1]!==``&&r.push(i[1])}t.addLineGeometry(n,r)}else if(a===`p`){let e=i.slice(1).trim().split(` `);t.addPointGeometry(e)}else if((r=vf.exec(i))!==null){let e=(` `+r[0].slice(1).trim()).slice(1);t.startObject(e)}else if(bf.test(i))t.object.startMaterial(i.substring(7).trim(),t.materialLibraries);else if(yf.test(i))t.materialLibraries.push(i.substring(7).trim());else if(xf.test(i))console.warn(`THREE.OBJLoader: Rendering identifier "usemap" not supported. Textures must be defined in MTL files.`);else if(a===`s`){if(r=i.split(` `),r.length>1){let e=r[1].trim().toLowerCase();t.object.smooth=e!==`0`&&e!==`off`}else t.object.smooth=!0;let e=t.object.currentMaterial();e&&(e.smooth=t.object.smooth)}else{if(i===`\0`)continue;console.warn(`THREE.OBJLoader: Unexpected line: "`+i+`"`)}}}t.finalize();let i=new wn;if(i.materialLibraries=[].concat(t.materialLibraries),t.objects.length!==1||t.objects[0].geometry.vertices.length!==0)for(let e=0,n=t.objects.length;e<n;e++){let n=t.objects[e],r=n.geometry,a=n.materials,o=r.type===`Line`,s=r.type===`Points`,c=!1;if(r.vertices.length===0)continue;let l=new Er;l.setAttribute(`position`,new Y(r.vertices,3)),r.normals.length>0&&l.setAttribute(`normal`,new Y(r.normals,3)),r.colors.length>0&&(c=!0,l.setAttribute(`color`,new Y(r.colors,3))),r.hasUVIndices===!0&&l.setAttribute(`uv`,new Y(r.uvs,2));let u=[];for(let e=0,n=a.length;e<n;e++){let n=a[e],r=n.name+`_`+n.smooth+`_`+c,i=t.materials[r];if(this.materials!==null){if(i=this.materials.create(n.name),o&&i&&!(i instanceof Mi)){let e=new Mi;jr.prototype.copy.call(e,i),e.color.copy(i.color),i=e}else if(s&&i&&!(i instanceof Ki)){let e=new Ki({size:10,sizeAttenuation:!1});jr.prototype.copy.call(e,i),e.color.copy(i.color),e.map=i.map,i=e}}i===void 0&&(i=o?new Mi:s?new Ki({size:1,sizeAttenuation:!1}):new ao,i.name=n.name,i.flatShading=!n.smooth,i.vertexColors=c,t.materials[r]=i),u.push(i)}let d;if(u.length>1){for(let e=0,t=a.length;e<t;e++){let t=a[e];l.addGroup(t.groupStart,t.groupCount,e)}d=o?new Wi(l,u):s?new Zi(l,u):new X(l,u)}else d=o?new Wi(l,u[0]):s?new Zi(l,u[0]):new X(l,u[0]);d.name=n.name,i.add(d)}else if(t.vertices.length>0){let e=new Ki({size:1,sizeAttenuation:!1}),n=new Er;n.setAttribute(`position`,new Y(t.vertices,3)),t.colors.length>0&&t.colors[0]!==void 0&&(n.setAttribute(`color`,new Y(t.colors,3)),e.vertexColors=!0);let r=new Zi(n,e);i.add(r)}return i}},jf=`/outcome-memories-2.5d/assets/tdoll-BWRzHYkq.obj`,Mf=`/outcome-memories-2.5d/assets/player01-DiHQht80.png`,Nf=`/outcome-memories-2.5d/assets/2011x-CN59nAJR.glb`,Pf=`/outcome-memories-2.5d/assets/starved_eggman-CwBKC4V3.glb`,Ff=class{constructor(e,t,n,r=`Tripwire`){this.scene=e,this.controls=t,this.type=r,this.config=_f[r]||_f.Tripwire;let i=new oa(4,12,6),a=new ro({color:n,emissive:5570560});if(this.mesh=new X(i,a),this.mesh.position.y=6,this.mesh.castShadow=!0,e.add(this.mesh),r===`Tripwire`){let e=new Af;new Bo().load(Mf,t=>{t.flipY=!1,t.colorSpace=Be,e.load(jf,e=>{e.traverse(e=>{e.isMesh&&(e.material=new ro({map:t,transparent:!0}),e.castShadow=!0)});let n=this.setupModel(e);this.swapMesh(n)})})}else if(r===`2011X`||r===`Starved`){let e=new ld,t=r===`2011X`?Nf:Pf;e.load(t,e=>{let t=e.scene;t.traverse(e=>{e.isMesh&&(e.castShadow=!0)});let n=this.setupModel(t);this.swapMesh(n)})}this.maxSpeed=this.config.speed,this.currentSpeed=1,this.size=this.config.size,this.stunned=0,this.controlId=`p2`,this.isAI=!1,this.velocity=new W(0,0,0),this.acceleration=.2,this.damping=.85,this.navPath=null,this.navPathIndex=0,this.navRepathTimer=0,this.lastPos={x:0,z:0},this.stuckTimer=0,this.unstickTimer=0,this.unstickAngle=0,this.m1State=`idle`,this.m1Timer=0,this.m1Cooldown=0,this.m1HitboxCount=0,this.m1AttackAngle=new W(0,0,1),this.ability1Cooldown=0,this.ability2Cooldown=0,this.grappleState=`idle`,this.grappleTarget=null,this.grappleTimer=0,this.grappleLine=null,this.grappleProjectile=null,this.activeBomb=null,this.teleportState=`idle`,this.teleportTimer=0,this.trickeryState=`idle`,this.trickeryTimer=0,this.trickeryAngle=0,this.stunCount=0,this.isRushing=!1,this.rushTimer=0}swapMesh(e){let t=this.mesh.position.x,n=this.mesh.position.z,r=this.mesh.rotation.y;this.scene.remove(this.mesh),this.mesh=e,this.mesh.position.set(t,6,n),this.mesh.rotation.y=r,this.scene.add(this.mesh)}setupModel(e){let t=new wn,n=new wn;n.rotation.y=Math.PI/2,n.add(e),t.add(n);let r=new Jn().setFromObject(t);if(r.isEmpty())return t;let i=r.getSize(new W),a=i.y>0?8/i.y:1;t.scale.setScalar(a);let o=new Jn().setFromObject(t).getCenter(new W);return t.position.sub(o),t}setEmissive(e){let t=t=>{t.isMesh&&t.material&&(Array.isArray(t.material)?t.material.forEach(t=>{t.emissive&&t.emissive.setHex(e)}):t.material.emissive&&t.material.emissive.setHex(e))};this.mesh.isMesh?t(this.mesh):this.mesh.traverse(t)}destroy(){this.grappleLine&&this.removeGrappleLine(),this.activeBomb&&this.removeBomb(),this.scene.remove(this.mesh)}stun(e){this.stunned=e,this.setEmissive(16777215),this.velocity.set(0,0,0),this.currentSpeed=1,this.type===`2011X`&&this.config.rush&&!this.isRushing&&(this.stunCount++,this.stunCount>=this.config.rush.stunThreshold&&(this.isRushing=!0,this.rushTimer=this.config.rush.duration,this.stunCount=0,this.setEmissive(16711680)))}resolveWallStuck(e){for(let t of e){let e=t.mesh.position.y+5;if(this.mesh.position.y-6<e-.2&&qu(this.mesh.position.x,this.mesh.position.z,this.size,t.x,t.z,t.w,t.d)){let e=Math.max(t.x,Math.min(this.mesh.position.x,t.x+t.w)),n=Math.max(t.z,Math.min(this.mesh.position.z,t.z+t.d)),r=this.mesh.position.x-e,i=this.mesh.position.z-n,a=Math.hypot(r,i);a>0?(this.mesh.position.x=e+r/a*(this.size+.1),this.mesh.position.z=n+i/a*(this.size+.1)):this.mesh.position.z=t.z-this.size-.1,this.velocity.set(0,0,0)}}}update(e,t,n){if(n&&n.dev&&n.dev.freezeKiller){this.velocity.set(0,0,0),this.resolveWallStuck(e);return}if(this.isRushing&&(this.rushTimer--,this.rushTimer<=0&&(this.isRushing=!1,this.setEmissive(5570560))),this.stunned>0){this.stunned--,this.stunned===0&&!this.isRushing&&this.setEmissive(5570560),this.velocity.x*=this.damping,this.velocity.z*=this.damping,this.mesh.position.x+=this.velocity.x,this.mesh.position.z+=this.velocity.z,this.resolveWallStuck(e);return}let r=0,i=0;if(this.isAI){let n=null,a=1/0;if(t.forEach(e=>{if(e.health>0){let t=Math.hypot(e.mesh.position.x-this.mesh.position.x,e.mesh.position.z-this.mesh.position.z);t<a&&t<=(this.config.ai?.visionRange||9999)&&(a=t,n=e)}}),n){let t=n.mesh.position.x-this.mesh.position.x,a=n.mesh.position.z-this.mesh.position.z,o=Math.hypot(t,a),s=this.config.ai?.attackRange||12;if(this.controls.m1=o<=s,this.type===`Tripwire`&&this.config.abilities&&!this.isRushing&&(this.controls.ability1=o<=(this.config.abilities.grapple?.range||60)&&this.ability1Cooldown<=0&&this.hasLineOfSight(n,e),this.controls.ability2=o<=(this.config.abilities.bomb?.throwRange||80)&&this.ability2Cooldown<=0),this.type===`2011X`&&this.config.abilities&&!this.isRushing&&(this.controls.ability1=o<=60&&this.ability1Cooldown<=0,this.controls.ability2=o<=50&&this.ability2Cooldown<=0),o>s){this.updateStuckDetection();let s=null;this.unstickTimer>0?(this.unstickTimer--,s={x:Math.sin(this.unstickAngle),z:Math.cos(this.unstickAngle)}):s=o<15||o<100&&this.hasLineOfSight(n,e)?{x:t/o,z:a/o}:this.getNavDirection(n,e),s||={x:t/o,z:a/o},r=s.x,i=s.z}}else this.controls.m1=!1,this.controls.ability1=!1,this.controls.ability2=!1}else this.controls.up&&--i,this.controls.down&&(i+=1),this.controls.left&&--r,this.controls.right&&(r+=1);r!==0&&i!==0&&!this.isAI&&(r*=.707,i*=.707),r!==0||i!==0?this.currentSpeed+=(this.maxSpeed-this.currentSpeed)*.02:this.currentSpeed+=(1-this.currentSpeed)*.05;let a=this.currentSpeed;this.isRushing&&(a*=this.config.rush.speedMultiplier);let o=r*a,s=i*a;this.velocity.x+=(o-this.velocity.x)*this.acceleration,this.velocity.z+=(s-this.velocity.z)*this.acceleration,r===0&&(this.velocity.x*=this.damping),i===0&&(this.velocity.z*=this.damping);let c=this.mesh.position.x+this.velocity.x,l=this.mesh.position.z+this.velocity.z,u=!1,d=!1;for(let t of e){let e=t.mesh.position.y+5;this.mesh.position.y-6<e-.2&&(qu(c,this.mesh.position.z,this.size,t.x,t.z,t.w,t.d)&&(u=!0),qu(this.mesh.position.x,l,this.size,t.x,t.z,t.w,t.d)&&(d=!0))}u?this.velocity.x=0:this.mesh.position.x=c,d?this.velocity.z=0:this.mesh.position.z=l,this.velocity.lengthSq()>.1&&(this.mesh.rotation.y=Math.atan2(this.velocity.x,this.velocity.z)),this.m1Cooldown>0&&this.m1Cooldown--,this.ability1Cooldown>0&&this.ability1Cooldown--,this.ability2Cooldown>0&&this.ability2Cooldown--,this.updateM1(t,n,r,i),this.isRushing||(this.type===`Tripwire`&&this.config.abilities&&(this.updateGrapple(t,e,n),this.updateBomb(t,e,n)),this.type===`2011X`&&this.config.abilities&&(this.updateTeleport(t,n),this.updateTrickery(t,n)));let f=!1;this.type===`Tripwire`&&(this.grappleState===`shooting`&&(f=!0),this.activeBomb&&this.activeBomb.state===`flying`&&(f=!0)),this.type===`2011X`&&(this.teleportState===`windup`&&(f=!0),this.trickeryState===`active`&&(f=!0)),f&&Math.floor(Date.now()/100)%2==0?this.setEmissive(16777215):this.setEmissive(5570560),this.resolveWallStuck(e)}hasLineOfSight(e,t){let n=this.mesh.position.x,r=this.mesh.position.z,i=e.mesh.position.x-n,a=e.mesh.position.z-r,o=Math.hypot(i,a);if(o<.001)return!0;let s=Math.max(1,Math.ceil(o/4));for(let e=1;e<=s;e++){let o=e/s,c=n+i*o,l=r+a*o;for(let e of t)if(qu(c,l,this.size,e.x,e.z,e.w,e.d))return!1}return!0}updateStuckDetection(){let e=Math.hypot(this.mesh.position.x-this.lastPos.x,this.mesh.position.z-this.lastPos.z);this.lastPos={x:this.mesh.position.x,z:this.mesh.position.z},e<.5?this.stuckTimer++:this.stuckTimer=0,this.stuckTimer>45&&(this.stuckTimer=0,this.navRepathTimer=0,this.unstickTimer=30,this.unstickAngle=Math.random()*Math.PI*2)}getNavDirection(e,t){this.navRepathTimer--,this.navRepathTimer<=0&&(this.navRepathTimer=15,this.computeNavPath(e,t));let n=this.navPath;if(!n||n.length===0)return null;let r=this.navPathIndex;for(;r<n.length-1&&Math.hypot(n[r].x-this.mesh.position.x,n[r].z-this.mesh.position.z)<5;)r++;this.navPathIndex=r;let i=n[r].x-this.mesh.position.x,a=n[r].z-this.mesh.position.z,o=Math.hypot(i,a);return o<.001?null:{x:i/o,z:a/o}}computeNavPath(e,t){let n=this.buildNavGrid(t),r=this.nearestFreeCell(this.worldToCell(this.mesh.position.x,this.mesh.position.z,n),n),i=this.nearestFreeCell(this.worldToCell(e.mesh.position.x,e.mesh.position.z,n),n);if(!r||!i){this.navPath=null;return}let a=n.size,o=r.r*a+r.c,s=i.r*a+i.c,c=new Int32Array(a*a).fill(-1),l=new Uint8Array(a*a),u=[o];l[o]=1;let d=0;for(;d<u.length;){let e=u[d++];if(e===s)break;let t=Math.floor(e/a),r=e%a,i=[[r-1,t],[r+1,t],[r,t-1],[r,t+1]];for(let[t,r]of i){if(t<0||t>=a||r<0||r>=a)continue;let i=r*a+t;l[i]||n.blocked[i]||(l[i]=1,c[i]=e,u.push(i))}}if(!l[s]){this.navPath=null;return}let f=[],p=s;for(;p!==-1;){let e=Math.floor(p/a),t=p%a;f.push({x:n.min+(t+.5)*n.cell,z:n.min+(e+.5)*n.cell}),p=c[p]}f.reverse(),this.navPath=f,this.navPathIndex=Math.min(1,f.length-1)}buildNavGrid(e){let t=-100,n=new Uint8Array(2500),r=this.size+.5;for(let i of e){let e=Math.max(0,Math.floor((i.x-r-t)/4)),a=Math.min(49,Math.floor((i.x+i.w+r-t)/4)),o=Math.max(0,Math.floor((i.z-r-t)/4)),s=Math.min(49,Math.floor((i.z+i.d+r-t)/4));for(let c=o;c<=s;c++)for(let o=e;o<=a;o++)n[c*50+o]||qu(t+(o+.5)*4,t+(c+.5)*4,r,i.x,i.z,i.w,i.d)&&(n[c*50+o]=1)}return{blocked:n,cell:4,min:t,size:50}}worldToCell(e,t,n){let r=Math.floor((e-n.min)/n.cell),i=Math.floor((t-n.min)/n.cell);return r<0||r>=n.size||i<0||i>=n.size?null:{r:i,c:r}}nearestFreeCell(e,t){if(!e)return null;if(!t.blocked[e.r*t.size+e.c])return e;for(let n=1;n<=6;n++)for(let r=-n;r<=n;r++)for(let i=-n;i<=n;i++){if(Math.max(Math.abs(r),Math.abs(i))!==n)continue;let a=e.r+r,o=e.c+i;if(!(a<0||a>=t.size||o<0||o>=t.size)&&!t.blocked[a*t.size+o])return{r:a,c:o}}return null}updateM1(e,t,n,r){if(this.controls.m1&&this.m1State===`idle`&&this.m1Cooldown<=0&&(this.m1State=`windup`,this.m1Timer=this.config.m1.windup||0,this.m1HitboxCount=0,n!==0||r!==0?this.m1AttackAngle.set(n,0,r).normalize():this.m1AttackAngle.set(Math.sin(this.mesh.rotation.y),0,Math.cos(this.mesh.rotation.y)).normalize(),t.audio.playSfx(this.type,this.config.m1.sfx)),this.m1State===`windup`&&(this.m1Timer<=0&&(this.m1State=`attacking`,this.m1Timer=this.config.m1.attackDuration||this.config.m1.duration),this.m1Timer--),this.m1State===`attacking`){let e=this.config.m1.hitCount||1;if((this.config.m1.hitCount?this.m1Timer%2==0:this.m1HitboxCount===0)&&this.m1HitboxCount<e){let e=this.mesh.position.x+this.m1AttackAngle.x*10,n=this.mesh.position.z+this.m1AttackAngle.z*10,r=this.config.m1.hitboxType,i=this.config.m1.applyBleed?{applyBleed:!0,bleedDuration:this.config.m1.bleedDuration||180}:null,a=this.config.m1.hitboxWidth||20,o=this.config.m1.hitboxDepth||20;t.spawnHitbox(e,n,0,10,this,r,this.config.m1.damage,i,`box`,a,o),this.m1HitboxCount++}this.m1Timer--,(this.m1Timer<=0||this.m1HitboxCount>=e)&&(this.m1State=`idle`,this.m1Cooldown=this.config.m1.cooldown||60)}}updateTeleport(e,t){let n=this.config.abilities.teleport;if(this.controls.ability1&&this.ability1Cooldown<=0&&this.teleportState===`idle`&&(this.teleportState=`windup`,this.teleportTimer=n.windup,this.ability1Cooldown=n.cooldown,t.audio.playSfx(this.type,n.sfx)),this.teleportState===`windup`&&(this.teleportTimer--,this.teleportTimer<=0)){let r=e[Math.floor(Math.random()*e.length)];if(r&&r.health>0){let e=Math.random()*Math.PI*2;this.mesh.position.x=r.mesh.position.x+Math.cos(e)*20,this.mesh.position.z=r.mesh.position.z+Math.sin(e)*20,this.mesh.position.x=Math.max(-90,Math.min(90,this.mesh.position.x)),this.mesh.position.z=Math.max(-90,Math.min(90,this.mesh.position.z)),t.spawnHitbox(this.mesh.position.x,this.mesh.position.z,n.arriveRadius,10,this,`teleport_arrive`,0,{applyBleed:!0,bleedDuration:n.bleedDuration},`sphere`)}this.navPath=null,this.navRepathTimer=0,this.teleportState=`idle`}}updateTrickery(e,t){let n=this.config.abilities.gods_trickery;if(this.controls.ability2&&this.ability2Cooldown<=0&&this.trickeryState===`idle`){this.trickeryState=`active`,this.trickeryTimer=n.duration,this.ability2Cooldown=n.cooldown,t.audio.playSfx(this.type,n.sfx);let r=null,i=1/0;e.forEach(e=>{if(e.health>0){let t=Math.hypot(e.mesh.position.x-this.mesh.position.x,e.mesh.position.z-this.mesh.position.z);t<i&&(i=t,r=e)}}),this.trickeryAngle=r?Math.atan2(r.mesh.position.z-this.mesh.position.z,r.mesh.position.x-this.mesh.position.x):this.mesh.rotation.y}if(this.trickeryState===`active`){if(this.trickeryTimer--,this.trickeryTimer%10==0){let e=(1-this.trickeryTimer/n.duration)*n.hitboxSpacing*n.hitboxCount,r=this.mesh.position.x+Math.cos(this.trickeryAngle)*(e+10),i=this.mesh.position.z+Math.sin(this.trickeryAngle)*(e+10);t.spawnHitbox(r,i,0,10,this,`gods_trickery`,0,{invertDuration:n.invertDuration},`box`,n.hitboxWidth,n.hitboxDepth)}this.trickeryTimer<=0&&(this.trickeryState=`idle`)}}updateGrapple(e,t,n){let r=this.config.abilities.grapple;if(r){if(this.grappleState===`idle`){if(this.controls.ability1&&this.ability1Cooldown<=0){let i=null,a=1/0;if(e.forEach(e=>{if(e.health>0){let t=Math.hypot(e.mesh.position.x-this.mesh.position.x,e.mesh.position.z-this.mesh.position.z);t<a&&(a=t,i=e)}}),i&&a<=r.range&&this.hasLineOfSight(i,t)){this.grappleState=`shooting`,this.grappleTarget=i,this.grappleProjectile={x:this.mesh.position.x,z:this.mesh.position.z},this.ability1Cooldown=r.cooldown,n.audio.playSfx(this.type,r.sfx);let e=new Mi({color:16711680}),t=[this.mesh.position,new W(this.grappleProjectile.x,6,this.grappleProjectile.z)],a=new Er().setFromPoints(t);this.grappleLine=new Bi(a,e),this.scene.add(this.grappleLine)}}}else if(this.grappleState===`shooting`){if(!this.grappleTarget||this.grappleTarget.health<=0){this.grappleState=`idle`,this.removeGrappleLine();return}let e=this.grappleTarget.mesh.position.x-this.grappleProjectile.x,n=this.grappleTarget.mesh.position.z-this.grappleProjectile.z,i=Math.hypot(e,n);i>0&&(this.grappleProjectile.x+=e/i*r.projectileSpeed,this.grappleProjectile.z+=n/i*r.projectileSpeed);let a=[this.mesh.position,new W(this.grappleProjectile.x,6,this.grappleProjectile.z)];if(this.grappleLine.geometry.setFromPoints(a),Math.hypot(this.grappleTarget.mesh.position.x-this.grappleProjectile.x,this.grappleTarget.mesh.position.z-this.grappleProjectile.z)<5+this.grappleTarget.size)this.grappleTarget.takeDamage(r.damage,this),this.grappleState=`dragging`,this.grappleTimer=r.dragDuration;else{let e=!1;for(let n of t)if(qu(this.grappleProjectile.x,this.grappleProjectile.z,2,n.x,n.z,n.w,n.d)){e=!0;break}let n=Math.hypot(this.grappleProjectile.x-this.mesh.position.x,this.grappleProjectile.z-this.mesh.position.z);(e||n>r.range)&&(this.grappleState=`idle`,this.removeGrappleLine())}}else if(this.grappleState===`dragging`){if(this.grappleTarget&&this.grappleTarget.health>0){let e=this.mesh.position.x-this.grappleTarget.mesh.position.x,n=this.mesh.position.z-this.grappleTarget.mesh.position.z,i=Math.hypot(e,n);if(i>5){let a=this.grappleTarget,o=e/i*r.dragSpeed,s=n/i*r.dragSpeed;this.posBlocked(a.mesh.position.x+o,a.mesh.position.z,a.size,t)||(a.mesh.position.x+=o),this.posBlocked(a.mesh.position.x,a.mesh.position.z+s,a.size,t)||(a.mesh.position.z+=s);let c=[this.mesh.position,a.mesh.position];this.grappleLine.geometry.setFromPoints(c)}else this.grappleState=`idle`,this.removeGrappleLine();this.grappleTimer--,this.grappleTimer<=0&&(this.grappleState=`idle`,this.removeGrappleLine())}else this.grappleState=`idle`,this.removeGrappleLine()}}}posBlocked(e,t,n,r){for(let i of r)if(qu(e,t,n,i.x,i.z,i.w,i.d))return!0;return!1}removeGrappleLine(){this.grappleLine&&=(this.scene.remove(this.grappleLine),this.grappleLine.geometry.dispose(),this.grappleLine.material.dispose(),null)}updateBomb(e,t,n){let r=this.config.abilities.bomb;if(r){if(this.controls.ability2&&this.ability2Cooldown<=0&&!this.activeBomb){let e=new X(new Ga(3,8,8),new ro({color:0,emissive:5570560}));e.position.copy(this.mesh.position),e.position.y=3,this.scene.add(e),this.activeBomb={mesh:e,state:`placed`,vx:0,vz:0,lifetime:r.lifetime,placeTimer:180},this.ability2Cooldown=r.cooldown,n.audio.playSfx(this.type,r.sfx)}else if(this.controls.ability2&&this.activeBomb&&this.activeBomb.state===`placed`&&this.activeBomb.placeTimer<=0){let t=null,i=1/0;if(e.forEach(e=>{if(e.health>0){let n=Math.hypot(e.mesh.position.x-this.mesh.position.x,e.mesh.position.z-this.mesh.position.z);n<i&&(i=n,t=e)}}),t){let e=this.activeBomb,i=t.mesh.position.x-e.mesh.position.x,a=t.mesh.position.z-e.mesh.position.z,o=Math.hypot(i,a)||1;e.vx=i/o*r.launchSpeed,e.vz=a/o*r.launchSpeed,e.state=`flying`,n.audio.playSfx(this.type,r.sfx)}}if(this.activeBomb){let i=this.activeBomb;if(i.lifetime--,i.placeTimer>0&&i.placeTimer--,i.state===`flying`){i.mesh.position.x+=i.vx,i.mesh.position.z+=i.vz;let a=!1;for(let e of t){let t=e.mesh.position.y+5;if(i.mesh.position.y<t&&qu(i.mesh.position.x,i.mesh.position.z,3,e.x,e.z,e.w,e.d)){a=!0;break}}let o=null;e.forEach(e=>{e.health>0&&Math.hypot(e.mesh.position.x-i.mesh.position.x,e.mesh.position.z-i.mesh.position.z)<5+e.size&&(o=e)}),o?(o.takeDamage(r.impactDamage,this),e.forEach(e=>{e.health>0&&e!==o&&Math.hypot(e.mesh.position.x-i.mesh.position.x,e.mesh.position.z-i.mesh.position.z)<r.explodeRadius&&e.takeDamage(r.aoeDamage,this)}),n.audio.playSfx(this.type,r.explosionSfx),this.removeBomb()):a&&(i.state=`proximity`)}else if(i.state===`proximity`){let t=!1;e.forEach(e=>{e.health>0&&Math.hypot(e.mesh.position.x-i.mesh.position.x,e.mesh.position.z-i.mesh.position.z)<r.proximityRadius&&(t=!0)}),t&&(e.forEach(e=>{e.health>0&&Math.hypot(e.mesh.position.x-i.mesh.position.x,e.mesh.position.z-i.mesh.position.z)<r.explodeRadius&&e.takeDamage(r.proximityDamage,this)}),n.audio.playSfx(this.type,r.explosionSfx),this.removeBomb())}i.lifetime<=0&&this.removeBomb()}}}removeBomb(){this.activeBomb&&=(this.scene.remove(this.activeBomb.mesh),this.activeBomb.mesh.geometry.dispose(),this.activeBomb.mesh.material.dispose(),null)}},If=class{constructor(e){this.gameManager=e,this.root=document.getElementById(`ui-layer`),this.activeScreen=null,this.waitingForKey=null,this.hudElement=null}btn(e,t,n=!1){return`<button class="button-49 ${n?`btn-sm`:``}" id="${t}" role="button" data-text="${e}">${e}</button>`}initHUD(){this.hideAll(),this.root.innerHTML=`
        ...
        `,document.head.appendChild(e)}},Rf=class{constructor(){this.schemes={p1:{up:`w`,down:`s`,left:`a`,right:`d`,ability1:`q`,ability2:`e`,m1:` `},p2:{up:`arrowup`,down:`arrowdown`,left:`arrowleft`,right:`arrowright`,ability1:`/`,ability2:`.`,m1:`enter`},p3:{up:`t`,down:`g`,left:`f`,right:`h`,ability1:`r`,ability2:`y`,m1:`v`},p4:{up:`i`,down:`k`,left:`j`,right:`l`,ability1:`u`,ability2:`o`,m1:`p`}},this.load()}load(){try{let e=JSON.parse(localStorage.getItem(`om_25d_controls`));e&&(this.schemes.p1=e.p1||this.schemes.p1,this.schemes.p2=e.p2||this.schemes.p2,this.schemes.p3=e.p3||this.schemes.p3,this.schemes.p4=e.p4||this.schemes.p4)}catch(e){console.error(`Failed to load controls`,e)}}save(){localStorage.setItem(`om_25d_controls`,JSON.stringify(this.schemes))}getScheme(e){return this.schemes[e]}},zf=`/outcome-memories-2.5d/assets/killer_m1_1-Bfd6WJiV.mp3`,Bf=`/outcome-memories-2.5d/assets/killer_m1_hit_1-DtdZB-ZL.mp3`,Vf=`/outcome-memories-2.5d/assets/teleport_1-CuRmwaZV.mp3`,Hf=`/outcome-memories-2.5d/assets/teleport_2-D4lSdtxm.mp3`,Uf=`/outcome-memories-2.5d/assets/trickery_1-CV-FRo-J.mp3`,Wf=`/outcome-memories-2.5d/assets/trickery_2-CJAc26HG.mp3`,Gf=`/outcome-memories-2.5d/assets/trickery_3-DjZYDDKD.mp3`,Kf=`/outcome-memories-2.5d/assets/parry_1-YzqARsxU.mp3`,qf=`/outcome-memories-2.5d/assets/punch_1-Ccd-1zzM.mp3`,Jf=`/outcome-memories-2.5d/assets/block_sink_1-DXza9Kq8.mp3`,Yf=`/outcome-memories-2.5d/assets/jump_pad_1-K57kWRmD.mp3`,Xf=`/outcome-memories-2.5d/assets/dash_1-CUbo_nur.mp3`,Zf=`/outcome-memories-2.5d/assets/fly_1-C-IANcTP.mp3`,Qf=`/outcome-memories-2.5d/assets/gun_fire_1-DjtUz-Pp.mp3`,$f=`/outcome-memories-2.5d/assets/bomb_throw_1-Enh0Hnaa.mp3`,ep=`/outcome-memories-2.5d/assets/grapple_1-BmhadoAh.mp3`,tp=`/outcome-memories-2.5d/assets/menu1-1z5-C9OD.mp3`,np=`/outcome-memories-2.5d/assets/Tripwirechase-BC46v8Ga.mp3`,rp=`/outcome-memories-2.5d/assets/2011Xchase-DDzCFI0l.mp3`,ip=`/outcome-memories-2.5d/assets/Tailslms-Dux8OhLn.mp3`,ap=`/outcome-memories-2.5d/assets/Knuckleslms-B_MJeXgf.mp3`,op=`/outcome-memories-2.5d/assets/Eternal%20Hope_%20Eternal%20Fight-C8JYYcPV.mp3`,sp=Object.assign({"../assets/sfx/2011X/killer_m1_1.mp3":zf,"../assets/sfx/2011X/killer_m1_hit_1.mp3":Bf,"../assets/sfx/2011X/teleport_1.mp3":Vf,"../assets/sfx/2011X/teleport_2.mp3":Hf,"../assets/sfx/2011X/trickery_1.mp3":Uf,"../assets/sfx/2011X/trickery_2.mp3":Wf,"../assets/sfx/2011X/trickery_3.mp3":Gf,"../assets/sfx/Knuckles/parry_1.mp3":Kf,"../assets/sfx/Knuckles/punch_1.mp3":qf,"../assets/sfx/Map/block_sink_1.mp3":Jf,"../assets/sfx/Map/jump_pad_1.mp3":Yf,"../assets/sfx/Sonic/dash_1.mp3":Xf,"../assets/sfx/Tails/fly_1.mp3":Zf,"../assets/sfx/Tails/gun_fire_1.mp3":Qf,"../assets/sfx/Tripwire/bomb_throw_1.mp3":$f,"../assets/sfx/Tripwire/grapple_1.mp3":ep}),cp=class{constructor(){this.musicVolume=.5,this.sfxVolume=.8,this.currentTrack=null,this.audioElement=new Audio,this.audioElement.loop=!0,this.hasInteracted=!1,this.tracks={menu:tp,Tripwire:np,"2011X":rp,Tails_lms:ip,Knuckles_lms:ap,default_lms:op},this.sfxLibrary={},this.sfxCooldowns={},this.sfxCache={},this.sfxLastPick={};for(let e in sp){let t=sp[e],n=e.replace(`../assets/sfx/`,``).replace(`.mp3`,``).split(`/`);if(n.length===2){let e=n[0],r=n[1];if(r.includes(`_`)){let e=r.split(`_`);isNaN(e[e.length-1])||(e.pop(),r=e.join(`_`))}this.sfxLibrary[e]||(this.sfxLibrary[e]={}),this.sfxLibrary[e][r]||(this.sfxLibrary[e][r]=[]),this.sfxLibrary[e][r].push(t),this.sfxCache[t]||(this.sfxCache[t]=new Audio(t))}}this.load(),this.applyVolume()}load(){let e=localStorage.getItem(`om_music_vol`);this.musicVolume=e===null?.5:parseFloat(e);let t=localStorage.getItem(`om_sfx_vol`);this.sfxVolume=t===null?.8:parseFloat(t)}save(){localStorage.setItem(`om_music_vol`,this.musicVolume),localStorage.setItem(`om_sfx_vol`,this.sfxVolume)}applyVolume(){this.audioElement.volume=this.musicVolume;let e=document.getElementById(`menu-video`);e&&(e.volume=this.musicVolume)}playMusic(e){let t=this.tracks[e];!t||this.currentTrack===e||(this.audioElement.src=t,this.applyVolume(),this.audioElement.play().catch(()=>{}),this.currentTrack=e)}stopMusic(){this.audioElement.pause(),this.audioElement.currentTime=0,this.currentTrack=null}playSfx(e,t){if(!e||!t)return;let n=`${e}_${t}`,r=Date.now();if(this.sfxCooldowns[n]&&r-this.sfxCooldowns[n]<100)return;this.sfxCooldowns[n]=r;let i=this.sfxLibrary[e]?.[t];if(i&&i.length>0){let e=i[0];if(i.length>1){do e=i[Math.floor(Math.random()*i.length)];while(e===this.sfxLastPick[n]);this.sfxLastPick[n]=e}let t=this.sfxCache[e].cloneNode();t.volume=this.sfxVolume,t.play().catch(()=>{})}}},lp=class{constructor(e,t,n,r,i,a,o,s,c=0,l=null,u=`sphere`,d=0,f=0){this.scene=t,this.x=n,this.z=r,this.radius=i,this.width=d,this.depth=f,this.duration=a,this.maxDuration=a,this.owner=o,this.type=s,this.damage=c,this.data=l,this.shape=u,this.hasHit=new Set;let p,m;m=new Br({color:16711680,wireframe:!0,transparent:!0,opacity:.5}),p=u===`box`?new ra(Math.max(1,d),10,Math.max(1,f)):new Ga(Math.max(1,i),8,8),this.mesh=new X(p,m),this.mesh.position.set(n,5,r),this.mesh.visible=e.settings.showHitboxes,t.add(this.mesh)}update(e){return this.duration--,this.mesh.material.opacity=this.duration/this.maxDuration*.5,this.mesh.visible=e.settings.showHitboxes,this.duration<=0?(this.scene.remove(this.mesh),!1):!0}},up=class{constructor(e,t,n,r,i,a,o,s,c=3){this.scene=e,this.x=t,this.z=n,this.dx=r,this.dz=i,this.owner=a,this.damage=o,this.stunDuration=s,this.speed=c,this.active=!0;let l=new Ga(1.5,8,8),u=new Br({color:16776960});this.mesh=new X(l,u),this.mesh.position.set(t,8,n),e.add(this.mesh)}update(e){if(this.x+=this.dx*this.speed,this.z+=this.dz*this.speed,this.mesh.position.x=this.x,this.mesh.position.z=this.z,Math.abs(this.x)>100||Math.abs(this.z)>100){this.destroy();return}for(let t of e)if(Ju(this.x,this.z,1.5,t.mesh.position.x,t.mesh.position.z,t.size)){t.takeDamage(this.damage,this.owner),t.stun(this.stunDuration),this.destroy();break}}destroy(){this.active=!1,this.scene.remove(this.mesh)}},dp=class{constructor(e,t,n){this.scene=e;let r=new Ka(5,1.5,8,24),i=new ro({color:16766720,emissive:16755200});this.mesh=new X(r,i),this.mesh.position.set(t,5,n),this.mesh.rotation.x=Math.PI/2,e.add(this.mesh)}update(){this.mesh.rotation.z+=.05}destroy(){this.scene.remove(this.mesh)}},fp=class{constructor(e){this.scene=e,this.time=0;let t=new oa(3.5,9,3);t.rotateX(Math.PI/2);let n=new Br({color:65535});this.mesh=new X(t,n),this.mesh.position.y=13,this.mesh.visible=!1,e.add(this.mesh)}update(e,t){if(!t){this.mesh.visible=!1;return}this.time++,this.mesh.visible=!0,this.mesh.position.x=e.x,this.mesh.position.z=e.z,this.mesh.position.y=13+Math.sin(this.time*.1)*1.2;let n=t.x-e.x,r=t.z-e.z;(n!==0||r!==0)&&(this.mesh.rotation.y=Math.atan2(n,r));let i=1+Math.sin(this.time*.2)*.08;this.mesh.scale.setScalar(i)}destroy(){this.scene.remove(this.mesh)}};new class{constructor(){this.engine=new Gu,this.mapManager=new Yu(this.engine.scene),this.ui=new If(this),this.controls=new Rf,this.audio=new cp;let e=localStorage.getItem(`om_show_hitboxes`);this.settings={showHitboxes:e===null||e===`true`},this.dev={gasterUnlocked:!1,godMode:!1,freezeKiller:!1},this.devPanel=new Lf(this),this.state=`MENU`,this.keys={},this.gamepadStates={},this.setupInput(),this.players=[],this.killers=[],this.activeHitboxes=[],this.projectiles=[],this.ring=null,this.arrow=null,this.gameSetup={survivorCount:1,selectedSurvivors:[`Sonic`,`Tails`,`Knuckles`],selectedKillerType:`Tripwire`,killerPlayer:2,killerIsAI:!1,selectedMap:`Open Field`};let t=()=>{this.audio.hasInteracted=!0,this.ui.showScreen(this.ui.activeScreen),window.removeEventListener(`click`,t),window.removeEventListener(`keydown`,t)};window.addEventListener(`click`,t),window.addEventListener(`keydown`,t),this.startGamepadPolling()}setupInput(){window.addEventListener(`keydown`,e=>{if(this.keys[e.key.toLowerCase()]=!0,e.code===`Backquote`&&e.shiftKey){this.devPanel.toggle();return}e.key===`Escape`&&this.state===`PLAYING`?(this.state=`PAUSED`,this.audio.stopMusic(),this.ui.showScreen(`setup`)):e.key===`Escape`&&this.state===`PAUSED`&&(this.state=`PLAYING`,this.ui.initHUD(),this.audio.playMusic(this.gameSetup.selectedKillerType))}),window.addEventListener(`keyup`,e=>{this.keys[e.key.toLowerCase()]=!1})}startGamepadPolling(){let e=()=>{let t=navigator.getGamepads();this.gamepadStates={};for(let e=0;e<t.length;e++){let n=t[e];n&&(this.gamepadStates[`p${e+1}`]={up:n.buttons[12]?.pressed||n.axes[1]<-.5,down:n.buttons[13]?.pressed||n.axes[1]>.5,left:n.buttons[14]?.pressed||n.axes[0]<-.5,right:n.buttons[15]?.pressed||n.axes[0]>.5,m1:n.buttons[0]?.pressed,ability1:n.buttons[1]?.pressed,ability2:n.buttons[2]?.pressed})}requestAnimationFrame(e)};requestAnimationFrame(e)}start(){this.ui.showScreen(`main`),this.gameLoop()}findSafeSpawn(e,t,n){let r,i,a=!1,o=0;for(;!a&&o<100;){r=Math.random()*120-60,i=Math.random()*(n-t)+t,a=!0;for(let t of e)if(qu(r,i,6,t.x,t.z,t.w,t.d)){a=!1;break}o++}return{x:r,z:i}}async startGame(){this.state=`LOADING`,this.ui.showLoadingScreen();let e=[],t=this.gameSetup.selectedSurvivors.slice(0,this.gameSetup.survivorCount);t.includes(`Sonic`)&&e.push(lf,uf),t.includes(`Tails`)&&e.push(pf,mf),t.includes(`Knuckles`)&&e.push(df,ff),t.includes(`Gaster`)&&e.push(hf);let n=this.gameSetup.selectedKillerType;n===`Tripwire`&&e.push(jf,Mf),n===`2011X`&&e.push(Nf),n===`Starved`&&e.push(Pf);try{await Promise.all(e.map(e=>fetch(e)))}catch(e){console.error(`Failed to preload assets`,e)}await new Promise(e=>setTimeout(e,2e3)),this.initializeGame()}initializeGame(){this.state=`PLAYING`,this.phase=`ROUND`,this.players.forEach(e=>this.engine.scene.remove(e.mesh)),this.killers.forEach(e=>e.destroy()),this.ring&&this.ring.destroy(),this.arrow&&this.arrow.destroy(),this.activeHitboxes.forEach(e=>this.engine.scene.remove(e.mesh)),this.projectiles.forEach(e=>this.engine.scene.remove(e.mesh)),this.players=[],this.killers=[],this.activeHitboxes=[],this.projectiles=[],this.ring=null,this.arrow=null,this.mapManager.loadMap(this.gameSetup.selectedMap);let e=[`p1`,`p2`,`p3`,`p4`],t=this.gameSetup.killerIsAI?null:`p${this.gameSetup.killerPlayer}`,n=e.filter(e=>e!==t),r={Sonic:25855,Tails:16766720,Knuckles:13574176,Gaster:15263976};for(let e=0;e<this.gameSetup.survivorCount;e++){let t=n[e],i={up:!1,down:!1,left:!1,right:!1,ability1:!1,ability2:!1,m1:!1},a=this.gameSetup.selectedSurvivors[e],o=r[a]||25855,s=new gf(this.engine.scene,i,o,a);s.gameManager=this;let c=this.findSafeSpawn(this.mapManager.obstacles,-90,-50);s.mesh.position.set(c.x,6,c.z),s.controlId=t,this.players.push(s)}let i={up:!1,down:!1,left:!1,right:!1,ability1:!1,ability2:!1,m1:!1},a=16711680;this.gameSetup.selectedKillerType===`Tripwire`?a=16562691:this.gameSetup.selectedKillerType===`2011X`?a=11730944:this.gameSetup.selectedKillerType===`Starved`&&(a=9109504),this.killer=new Ff(this.engine.scene,i,a,this.gameSetup.selectedKillerType);let o=this.findSafeSpawn(this.mapManager.obstacles,50,90);this.killer.mesh.position.set(o.x,6,o.z),this.gameSetup.killerIsAI?this.killer.isAI=!0:this.killer.controlId=t,this.killers.push(this.killer),this.players.forEach(e=>{e.ability1Cooldown=120,e.ability2Cooldown=120}),this.killers.forEach(e=>{e.ability1Cooldown=120,e.ability2Cooldown=120}),this.ui.initHUD(),this.totalSurvivors=this.players.length,this.gameTimer=(this.totalSurvivors*30+30)*60,this.lmsTimer=3600,this.ringTimer=900,this.totalSurvivors<=1?(this.phase=`LMS`,this.playLmsMusic(this.players[0])):this.audio.playMusic(this.gameSetup.selectedKillerType)}playLmsMusic(e){if(!e)return;let t=e.characterName;t===`Tails`?this.audio.playMusic(`Tails_lms`):t===`Knuckles`?this.audio.playMusic(`Knuckles_lms`):this.audio.playMusic(`default_lms`)}getSelectableSurvivors(){let e=[`Sonic`,`Tails`,`Knuckles`];return this.dev.gasterUnlocked&&e.push(`Gaster`),e}stopGame(){this.state=`MENU`,this.ring&&this.ring.destroy(),this.arrow&&this.arrow.destroy(),this.ring=null,this.arrow=null,this.audio.stopMusic(),this.ui.showScreen(`main`)}endGame(e,t){this.state=`GAME_OVER`,this.phase=`GAME_OVER`,this.ring&&=(this.ring.destroy(),null),this.arrow&&=(this.arrow.destroy(),null),this.audio.stopMusic(),this.ui.showGameOver(e,t)}spawnHitbox(e,t,n,r,i,a,o,s,c=`sphere`,l=0,u=0){this.activeHitboxes.push(new lp(this,this.engine.scene,e,t,n,r,i,a,o,s,c,l,u))}spawnProjectile(e,t,n,r,i,a,o,s){this.projectiles.push(new up(this.engine.scene,e,t,n,r,i,a,o,s))}gameLoop(){if(requestAnimationFrame(()=>this.gameLoop()),this.state===`PLAYING`){this.mapManager.update(this.players,this.killers,this.audio),this.players.forEach(e=>{let t=this.controls.getScheme(e.controlId),n=this.gamepadStates[e.controlId];e.controls.up=this.keys[t.up]||(n?n.up:!1),e.controls.down=this.keys[t.down]||(n?n.down:!1),e.controls.left=this.keys[t.left]||(n?n.left:!1),e.controls.right=this.keys[t.right]||(n?n.right:!1),e.controls.ability1=this.keys[t.ability1]||(n?n.ability1:!1),e.controls.ability2=this.keys[t.ability2]||(n?n.ability2:!1),e.controls.m1=this.keys[t.m1]||(n?n.m1:!1),e.update(this.mapManager.obstacles,this.killers,this,this.players)}),this.killers.forEach(e=>{let t=this.controls.getScheme(e.controlId),n=this.gamepadStates[e.controlId];e.isAI||(e.controls.up=this.keys[t.up]||(n?n.up:!1),e.controls.down=this.keys[t.down]||(n?n.down:!1),e.controls.left=this.keys[t.left]||(n?n.left:!1),e.controls.right=this.keys[t.right]||(n?n.right:!1),e.controls.m1=this.keys[t.m1]||(n?n.m1:!1),e.controls.ability1=this.keys[t.ability1]||(n?n.ability1:!1),e.controls.ability2=this.keys[t.ability2]||(n?n.ability2:!1)),e.update(this.mapManager.obstacles,this.players,this)});for(let e=this.projectiles.length-1;e>=0;e--){let t=this.projectiles[e];t.update(this.killers),t.active||this.projectiles.splice(e,1)}for(let e=this.activeHitboxes.length-1;e>=0;e--){let t=this.activeHitboxes[e];t.owner instanceof Ff?this.players.forEach(e=>{if(e.health>0&&!t.hasHit.has(e)){let n=!1;n=t.shape===`box`?qu(e.mesh.position.x,e.mesh.position.z,e.size,t.x-t.width/2,t.z-t.depth/2,t.width,t.depth):Ju(t.x,t.z,t.radius,e.mesh.position.x,e.mesh.position.z,e.size),n&&(e.takeDamage(t.damage,t.owner),t.data&&t.data.applyBleed&&(e.bleedTimer=t.data.bleedDuration||180),t.type===`gods_trickery`&&(e.invertedControlsTimer=t.data.invertDuration||180),t.type.includes(`killer_m1`)&&(e.hitSpeedBoost=45,this.audio.playSfx(t.owner.type,t.owner.config.m1.hitSfx||`m1_hit`)),t.hasHit.add(e))}}):t.owner instanceof gf&&t.type===`knuckles_punch`&&this.killers.forEach(e=>{if(!t.hasHit.has(e)){let n=!1;if(n=t.shape===`box`?qu(e.mesh.position.x,e.mesh.position.z,e.size,t.x-t.width/2,t.z-t.depth/2,t.width,t.depth):Ju(t.x,t.z,t.radius,e.mesh.position.x,e.mesh.position.z,e.size),n){e.stun(t.owner.config.abilities?.punch?.stunDuration||60);let n=new W(e.mesh.position.x-t.x,0,e.mesh.position.z-t.z);n.lengthSq()===0&&n.set(0,0,1),n.normalize();let r=t.owner.config.abilities?.punch?.knockback||15;e.mesh.position.x+=n.x*r,e.mesh.position.z+=n.z*r,t.hasHit.add(e)}}}),t.update(this)||this.activeHitboxes.splice(e,1)}let e=this.players.filter(e=>e.health>0),t=this.killer?this.killer.isRushing:!1;if(this.phase===`ROUND`)e.length===1&&this.totalSurvivors>1&&(this.phase=`LMS`,this.playLmsMusic(e[0])),t||this.gameTimer--,this.ui.updateHUD(`ROUND`,this.gameTimer/60,t),this.gameTimer<=0&&(this.phase=`LMS`,this.playLmsMusic(e[0]));else if(this.phase===`LMS`){if(t||this.lmsTimer--,this.ui.updateHUD(`LAST MAN STANDING`,this.lmsTimer/60,t),this.lmsTimer<=0){this.phase=`RING`;let e=this.findSafeSpawn(this.mapManager.obstacles,-80,80);this.ring=new dp(this.engine.scene,e.x,e.z),this.arrow=new fp(this.engine.scene)}}else if(this.phase===`RING`){if(this.ringTimer--,this.ring.update(),this.ui.updateHUD(`ESCAPE!`,this.ringTimer/60,!1),this.ring&&this.arrow&&this.killer&&this.arrow.update(this.killer.mesh.position,this.ring.mesh.position),this.ring){for(let t of e)if(Math.hypot(t.mesh.position.x-this.ring.mesh.position.x,t.mesh.position.z-this.ring.mesh.position.z)<6+t.size){this.endGame(`SURVIVOR ESCAPES`,`The ring was reached!`);return}}this.ringTimer<=0&&this.endGame(`KILLER WINS`,`Survivor was too slow`)}e.length===0&&this.phase!==`GAME_OVER`&&this.endGame(`KILLER WINS`,`All survivors eliminated`);let n=e[0]||this.players[0];n&&(this.engine.camera.position.x=n.mesh.position.x,this.engine.camera.position.z=n.mesh.position.z+50,this.engine.camera.lookAt(n.mesh.position.x,0,n.mesh.position.z))}this.engine.render()}}().start();