            ...
            `;else if(e===`settings`){let e=this.gameManager.controls.schemes,n=this.gameManager.audio,r=this.gameManager.settings.showHitboxes?`checked`:``;t=`
                <div class="menu-screen" id="settings-menu" style="display: block; padding: 30px; overflow-y: auto; width: 100%; height: 100%; box-sizing: border-box;">
                    ...
                    <div style="display: flex; gap: 20px; justify-content: center; flex-wrap: wrap;">
                        <div style="min-width: 220px;"><h3 style="text-align:center;">P1 (Survivor)</h3>${this.generateControlButtons(`p1`,e.p1)}</div>
                        <div style="min-width: 220px;"><h3 style="text-align:center;">P2 (Killer)</h3>${this.generateControlButtons(`p2`,e.p2)}</div>
                        <div style="min-width: 220px;"><h3 style="text-align:center;">P3 (Survivor)</h3>${this.generateControlButtons(`p3`,e.p3)}</div>
                        <div style="min-width: 220px;"><h3 style="text-align:center;">P4 (Survivor)</h3>${this.generateControlButtons(`p4`,e.p4)}</div>
                    </div>
